 ...
 * exit prevention with unresolved bids, and "My Purchases" view.
 */
public class AgentApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setOnCloseRequest(event -> {
            ...
            if (agent != null) {
                agent.disconnect(); // No checked exceptions
    ...
    // Thread-safe item loading with proper null checks
        ...
        new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    setStatusMessage("Failed to load items", "red");
                });
            } catch (ClassNotFoundException e) {
                Platform.runLater(() -> {
